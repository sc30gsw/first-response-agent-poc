...
export function WorkspaceShell({ children, currentThreadId, threads }: WorkspaceShellProps) {
  ...
  return (
    <div className="grid min-h-screen grid-cols-[280px_minmax(0,1fr)] grid-rows-[64px_minmax(0,1fr)] bg-canvas max-sm:grid-cols-1 max-sm:grid-rows-[60px_auto_minmax(0,1fr)]">
