...
function ReportBlock({ kind }: { readonly kind: ReportBlockKind }) {
  ...
  switch (kind) {
    case "CaseSummary": return renderCaseSummary(context.output);
    case "PriorityBanner": return renderPriorityBanner(context.output);
    ...
    case "SimilarCases": return renderSimilarCases(context.output);
    case "Guides": return renderGuides(context.output);
    case "Experts": return renderExperts(context.output, context.canRespond, context.onRequestConsultation);
    case "Escalation": return renderEscalation(context.output, context.canRespond, context.onFocusComposer);
    case "ReanalysisChanges": return renderReanalysisChanges(context.output);
  }
}

function renderCaseSummary(output: AnalyzeCaseOutput) {
...
function renderPriorityBanner(output: AnalyzeCaseOutput) {
...
function renderSimilarCases(output: AnalyzeCaseOutput) {
...
function renderGuides(output: AnalyzeCaseOutput) {
...
function renderExperts(output: AnalyzeCaseOutput, canRespond: boolean, onRequestConsultation: (expert: Expert) => Promise<void>) {
...
function renderEscalation(output: AnalyzeCaseOutput, canRespond: boolean, onFocusComposer: () => void) {
...
function renderReanalysisChanges(output: AnalyzeCaseOutput) {
